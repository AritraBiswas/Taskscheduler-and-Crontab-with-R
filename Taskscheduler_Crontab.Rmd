...
Here the path `"C:\Users\Aritra\systime.R"` is the location of my script, this path must be change with the file location of your r script.
...
My computer was turned off during 2PM to 11PM on that day that's why there a jump in the graph at the same time this can be considered as a remined that in order to obtain data continously one must turn on a computer for a cetain period of time. 

This is just a example of where crontab can be used. There are many more things can be done using crontab, shiny and R. I'm going to present some examples related this topic and shiny soon. 


The source code for this is avaiable in [here](https://www.google.com) and a slider version of this presentation is avaiable [here](https://www.google.com).